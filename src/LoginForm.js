...
class LoginForm extends React.Component {
    ...
    async doLogin() {
        ...
        try {
            ...
            UserStore.username = 'John';
            let res = await fetch('https://api.uploadfile.ithub.io/login', {method: 'post', headers: {'Accept':'application/json','Content-Type': 'application/json'},
